<nav class="main-header navbar navbar-expand navbar-dark navbar-ungu">
  <ul class="navbar-nav">
    <li class="nav-item">
      <a class="nav-link" data-widget="pushmenu" href="#" role="button"><i class="fas fa-bars"></i></a>
    </li>
    <li class="nav-item d-none d-sm-inline-block">
      <a href="{{ route('backend.main') }}" class="nav-link">Sistem Informasi Perpustakaan Berbasis Web</a>
    </li>
  </ul>

<div>
  <div class="modal fade" id="modal-pengembalian" wire:ignore.self>
          ...
          @else
            <div class="row">
              ...
              <div class="col-lg-6 col-xl-6 mb-2">
                <h5>Pengembalian</h5>
                <hr>
                <form wire:submit.prevent="buatPengembalian()" method="post">
                  <div class="row">
                    <div class="col-lg-6 col-xl-6 pl-4 pr-4">
                      <div class="form-group">
                        <label for="">Tanggal Kembali : </label>
                        <input type="date" wire:model="tgl_kembali" name="tgl_kembali" id="tgl_kembali" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="col-lg-6 col-xl-6 pl-4 pr-4">
                      <div class="form-group">
                    ...
                    <div class="col-12 pl-4 pr-4">
                      <table class="table">
                        ...
                        <tr>
                          ...
                          <td>:</td>
                          <td class="text-center"><b>Rp. {{ number_format($diff * $denda, 0, ',', '.') }}</b></td>
                        </tr>
                        <tr>
                    ...
                    <div class="col-12 pl-4 pr-4">
                      <button type="submit" class="btn btn-success btn-block btn-sm" >
                        <span class="fa fa-check"></span> &ensp; Buat Data Pengembalian
                      </button>
                    </div>
                  </div>
                </form>
